...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.tb_bailiff_info = QPushButton(self.frame)
        self.buttonGroup = QButtonGroup(SettingsDialog)
        self.buttonGroup.setObjectName(u"buttonGroup")
        self.buttonGroup.addButton(self.tb_bailiff_info)
        self.tb_bailiff_info.setObjectName(u"tb_bailiff_info")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tb_bailiff_info.sizePolicy().hasHeightForWidth())
        self.tb_bailiff_info.setSizePolicy(sizePolicy)
        self.tb_bailiff_info.setCheckable(True)
        self.tb_bailiff_info.setFlat(True)

        self.verticalLayout_2.addWidget(self.tb_bailiff_info)

        self.tb_users_3 = QPushButton(self.frame)
        self.buttonGroup.addButton(self.tb_users_3)
        self.tb_users_3.setObjectName(u"tb_users_3")
        sizePolicy.setHeightForWidth(self.tb_users_3.sizePolicy().hasHeightForWidth())
        self.tb_users_3.setSizePolicy(sizePolicy)
        self.tb_users_3.setIconSize(QSize(32, 32))
        self.tb_users_3.setCheckable(True)
        self.tb_users_3.setFlat(True)

        self.verticalLayout_2.addWidget(self.tb_users_3)

        self.tb_users_2 = QPushButton(self.frame)
        self.buttonGroup.addButton(self.tb_users_2)
        self.tb_users_2.setObjectName(u"tb_users_2")
        sizePolicy.setHeightForWidth(self.tb_users_2.sizePolicy().hasHeightForWidth())
        self.tb_users_2.setSizePolicy(sizePolicy)
        self.tb_users_2.setIconSize(QSize(32, 32))
        self.tb_users_2.setCheckable(True)
        self.tb_users_2.setFlat(True)

        self.verticalLayout_2.addWidget(self.tb_users_2)

        self.tb_users = QPushButton(self.frame)
        self.buttonGroup.addButton(self.tb_users)
        self.tb_users.setObjectName(u"tb_users")
        sizePolicy.setHeightForWidth(self.tb_users.sizePolicy().hasHeightForWidth())
        self.tb_users.setSizePolicy(sizePolicy)
        self.tb_users.setIconSize(QSize(32, 32))
        self.tb_users.setCheckable(True)
        self.tb_users.setFlat(True)

        self.verticalLayout_2.addWidget(self.tb_users)
        ...
        self.gridLayout_2.addWidget(self.le_register_in, 1, 1, 1, 3)

        self.le_email = QLineEdit(self.page_bailiff)
        self.le_email.setObjectName(u"le_email")

        self.gridLayout_2.addWidget(self.le_email, 9, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.le_phone, 7, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.le_mobile, 7, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.le_address, 2, 1, 1, 3)

        self.le_name = QLineEdit(self.page_bailiff)
        self.le_name.setObjectName(u"le_name")

        self.gridLayout_2.addWidget(self.le_name, 0, 1, 1, 3)

        self.verticalSpacer_3 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_2.addItem(self.verticalSpacer_3, 10, 1, 1, 1)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.tb_bailiff_info.setText(QCoreApplication.translate("SettingsDialog", u"\u0645\u0639\u0644\u0648\u0645\u0627\u062a \u0627\u0644\u0645\u062d\u0636\u0631", None))
        self.tb_users_3.setText(QCoreApplication.translate("SettingsDialog", u"\u062e\u0635\u0627\u0626\u0635", None))
        self.tb_users_2.setText(QCoreApplication.translate("SettingsDialog", u"\u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645\u064a\u0646", None))
        self.tb_users.setText(QCoreApplication.translate("SettingsDialog", u"\u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645\u064a\u0646", None))
